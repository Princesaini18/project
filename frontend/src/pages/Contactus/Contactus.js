...
const Contactus = () => {
    ...
    const handlesubmit = () => {
        window.open(`mailto:princesaini@gmail.com?subject=Sample&body=${body}`)
    }
    return (
                ...
                <div className="showAdrss">
                    <div className="box">
                        ...
                        <div className="adressCtn">
                            ...
                            <h3> Address</h3>
                            <p>East Clothing 8th floor, 379 St, model town, Jalandar</p>
                        </div>
                    </div>
                    <div className="box">
                        ...
                        <div className="adressCtn">
                            ...
                            <h3>Lets Talk</h3>
                            <p className="infoCtn">9660757602</p>
                        </div>
                    </div>
                    <div className="box">
                        ...
                        <div className="adressCtn">
                            ...
                            <h3>Sale Support</h3>
                            <p className="infoCtn">eastclothing@gmail.com</p>
                        </div>
                    </div>
                </div>
            </div>
